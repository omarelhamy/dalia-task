...
class EmailSubscription extends HTMLElement {
    constructor() {
        ...
        const floatingWidget = this.shadowRoot.querySelector(".floating-widget");
        floatingWidget.querySelector("i").className =
            this.getAttribute("icon") || "far fa-envelope";
        this.callback = this.getAttribute("onSubmit") || "";
        this.appendStyle("https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css");
    }
    connectedCallback() {
        this.shadowRoot
            .querySelector("form")
